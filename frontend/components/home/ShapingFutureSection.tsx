...
export const ShapingFutureSection: React.FC = () => {
  return (
    <section className="py-24 bg-black border-b border-cyan-500/20 relative overflow-hidden text-center">
      {/* Ambient Horizontal Capsule Glow (matching frame_160.jpg) */}
      <div className="max-w-5xl mx-auto px-4 relative">
        <div className="relative rounded-3xl p-10 sm:p-16 border border-cyan-500/35 bg-gradient-to-b from-[#08152c]/90 via-[#040a17]/80 to-black overflow-hidden shadow-[0_0_60px_rgba(34,211,238,0.2)]">
          ...
          {/* Glowing Connecting Line & Floating Icons (matching frame_160.jpg) */}
          <div className="flex items-center justify-between max-w-md mx-auto mb-8 relative z-10">
            ...
            <div className="flex-1 h-[1px] bg-gradient-to-r from-cyan-500/60 via-cyan-400 to-cyan-500/60 mx-4 relative">
              <div className="absolute left-1/3 -top-1 w-2 h-2 rounded-full bg-cyan-400 shadow-[0_0_10px_#22d3ee] animate-pulse" />
              <div className="absolute right-1/4 -top-1 w-2 h-2 rounded-full bg-white shadow-[0_0_10px_#ffffff]" />
            </div>
            <div className="w-10 h-10 rounded-full bg-cyan-950/80 border border-cyan-500/50 flex items-center justify-center text-cyan-300 shadow-[0_0_15px_rgba(34,211,238,0.4)]">
          ...
          {/* Heading (matching frame_160.jpg) */}
          ...
          <div className="relative z-10 flex flex-wrap items-center justify-center gap-4">
            ...
            <Link href="/contact">
              <button className="px-7 py-3.5 rounded-lg text-xs font-semibold uppercase tracking-wider text-slate-200 bg-black/60 border border-slate-700 hover:border-cyan-400 transition-all">
